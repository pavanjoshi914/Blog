...
In a previous post we have discussed what Open Source is and how GSoC as an initiative by Google is enhancing open source culture.
...
After getting an introduction to GSoC you might have a great enthusiasm to know about how to crack GSoC specially in the first attempt. :fire:

Don't have a tag of prestigious institutes IITs NITs BITS pilani ? Aspiring to take your first step for a great engineering career and for a successful selection in GSoC ? :dizzy: You are at the right place!

In this post I will be explaining about how I managed to crack GSoC in my very first attempt and how I overcame all the challenges where students from very prestigious institutes were competing for the same :fireworks:.
...
:six: Apply for GSoC at GSoC website.
 
## How to Select Right Open Source Organization :computer:
 
Mentoring organizations selected by Google depends on a variety of major criteria. In any case you apply for any single organization, and it doesn't get selected by Google :expressionless:, you will be left with bare minimum time to prepare and apply for any other organization :pensive:.
 
To encounter this many students follow a general strategy of applying to at least two to three organizations for their selection. 

On the other hand, working with multiple organizations written in different technologies and preparing multiple proposals can lead to tremendous amounts of hard work along with the possibility of rejection too :no_mouth:.
 
In this fact I prefer big No to this strategy. In my case I focused more on my interest and according to it I analysed back to back frequently selected organizations in past few years and settled up with the CircuitVerse and started my journey with CircuitVerse.
...
Congratulations! :tada: :tada: You completed your first step of the GSoC Journey 🥳 🥳.
...
I also worked with some professors and engineers expert in digital electronics and belonging to prestigious foreign universities. Yup! It was a great learning experience for me 🤩
 
Selecting an open source organization was my matter of interest and on which technologies I would like to spend time. Consequently, I started working for CircuitVerse to begin my coding journey.
...
After gathering more information about codebases organization maintains and technologies used in them, you can begin with your contributions.
...
I started slow and with easy tasks and ended with development of different important features from scratch. When I started contributing to CircuitVerse I was not much familiar with Rails. With the progress I got familiar with Rails, MVC architecture, a lot of gems, rspec testing, behaviour driven development, API's, JWT's and a lot more.
 
I always either tried to find and fix issues on my own or I used to solve easy to solve existing issues, starting smaller is necessary in order to get familiar with coding conventions and get initial exposure to huge codebases.
...
Doesn't matter which organization you work with or which project you select to go with, you will always be finding students belonging to many prestigious institutes competing for the same project.
...
As you can participate in GSoC at most two times, competing with students who have already completed their GSoC one time or people coming from major technical backgrounds and from major premium institutes is hard though 😕
 
In order to stand strong while proposal evaluations I kept some key sections very strong
1. Your proposed solutions for the implementation of the project.
2. Your past contributions
3. Regular working with organization
4. GSoC qualification task
5. Past experience

Apart from this, I helped other contributors to begin their journey with organization, participating in important discussions, suggesting solutions, reviewing others' PR's and giving opinions for betterment helped a lot to tak up the edge.
...
* [Easy Announcement Feature](https://github.com/CircuitVerse/CircuitVerse/pull/1804)
 ...
 Developing this feature from scratch gives me a full overview of the codebase. While working on this I worked with almost every part of the codebase. Initially not familiar with the codebase, I still managed to complete it by learning concepts parallely.
